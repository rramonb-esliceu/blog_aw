        ...
        <nav class="bg-header epilogue font-nav-bar">
            <div class="d-flex flex-row text-light">
                ...
                <div class="d-flex flex-row">
                    <div class="menu-item text-center mt-3 ms-5 me-4"><a class="active" href="index.html">All</a></div>
    ...
    <div class="container px-default">
        <div class="row">
            <div class="col-12 col-lg-6 pb-5 border-bottom border-2">
                <div class="row">
                    <img src="img/image13.png" alt="" class="sm-img">
                </div>
                <p class="text-center text-info border border-info rounded-pill mt-3 col-3">Culture</p>
                <p class="opacity-40">Mathias Reding | Game Boost | 6 min read</p>
                <p class="opacity-40">December 20 ,2022</p>
                <h3 class="width-370">Introducing Anima + Lottie</h3>
                <p class="opacity-60 width-334">How to add a Lottie animation to a prototype in Sketch, Adobe XD or Figma</p>
            </div>
            <div class="col-12 col-lg-6 pb-5 border-bottom border-2">
                <div class="row">
                    <img src="img/image14.png" alt="" class="sm-img">
                </div>
                <p class="text-center text-info border border-info rounded-pill mt-3 col-3">Culture</p>
                <p class="opacity-40">Sarah Dorweiler | 3D Artist | 4 min read</p> 
                <p class="opacity-40">May 24,2022</p>
                <h3 class="width-370">Better Forms with Input Types, Auto-Complete, and Validation</h3>
                <p class="opacity-60 width-334">Anima allows designers to create high-fidelity prototypes inside Sketch, Adobe XD, and Figma and export HTML & CSS in a single click.</p>
            </div>
        </div>
    </div>
    <div class="container px-default pt-100">
        <div class="row">
            <h2 class="mb-4">Trending topics</h2>
            <div class="row">
                <div class="col-12 col-lg-6 pb-5">
                    <div class="row">
                        <img src="img/image15.png" alt="" class="sm-img">
                    </div>
                    <p class="text-center text-info border border-info rounded-pill mt-3 col-3">Culture</p>
                    <div class="row">
                        <div class="width-340">
                            <p class="opacity-40">Stephen Leonardi | Software Engineer | 4 min read</p>
                            <p class="opacity-40">September 8 ,2022</p>
                        </div>
                        <div class="width-334">
                            <h3 class="width-370">Learn how to organize Your Anima Project with Sections</h3>
                            <p class="opacity-60 width-334">Create dividers and drag screens to arrange your Anima projects.</p>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-lg-6 pb-5">
                    <div class="row">
                        <img src="img/image16.png" alt="" class="sm-img">
                    </div>
                    <p class="text-center text-info border border-info rounded-pill mt-3 col-3">Culture</p>
                    <div class="row">
                        <div class="width-340">
                            <p class="opacity-40">Kate Glotova | Art Director | 5 min read</p>
                            <p class="opacity-40">March 13 ,2022</p>
                        </div>
                        <div class="width-334">
                            <h3 class="width-370">Anima Introduces: the best Hints you should know</h3>
                            <p class="opacity-60 width-334">Hotspot Hints Help Guide Users Navigate Through a Prototype, Anima allows designers to create prototypes.</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-12 col-lg-6 pb-5">
                    <div class="row">
                        <img src="img/image17.png" alt="" class="sm-img">
                    </div>
                    <p class="text-center text-info border border-info rounded-pill mt-3 col-3">Culture</p>
                    <div class="row">
                        <div class="width-340">
                        ...
                        <div class="width-334">
                            <h3 class="width-370">Introducing Anima + Figma</h3>
                            <p class="opacity-60 width-334">How to add a Lottie animation to a prototype in Sketch, Adobe XD or Figma</p>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-lg-6 pb-5">
                    <div class="row">
                        <img src="img/image18.png" alt="" class="sm-img">
                    </div>
                    <p class="text-center text-info border border-info rounded-pill mt-3 col-3">Culture</p>
                    <div class="row">
                        <div class="width-340">
                        ...
                        <div class="width-334">
                            <h3 class="width-370">Better Forms with Input Types, Auto-Complete, and Validation</h3>
                            <p class="opacity-60 width-334">Anima allows designers to create high-fidelity prototypes inside all design tools.</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-12 col-lg-6 pb-5">
                    <div class="row">
                        <img src="img/image19.png" alt="" class="sm-img">
                    </div>
                    <p class="text-center text-info border border-info rounded-pill mt-3 col-3">Culture</p>
                    <div class="row">
                        <div class="width-340">
                            <p class="opacity-40">Kate Glotova | Art Director | 4 min read</p>
                            <p class="opacity-40">September 23 ,2022</p>
                        </div>
                        <div class="width-334">
                            <h3 class="width-370">Talking now about sharing!</h3>
                            <p class="opacity-60 width-334">Typography in advertising often reflects a company's brand. A brand may use typography to express its theme, personality, and message.</p>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-lg-6 pb-5">
                    <div class="row">
                        <img src="img/image20.png" alt="" class="sm-img">
                    </div>
                    <p class="text-center text-info border border-info rounded-pill mt-3 col-3">Culture</p>
                    <div class="row">
                        <div class="width-340">
                            <p class="opacity-40">Jessica Cordoba | Frontend Developer | 4 min read</p>
                            <p class="opacity-40">May 24,2022</p>
                        </div>
                        <div class="width-334">
                            <h3 class="width-370">What you need to know about code languages</h3>
                            <p class="opacity-60 width-334">Rather than having to jump into strict syntax rules. Python reads like English and is simple to understand for someone who's new to programming.</p>
                        </div>
                    </div>
                </div>
            </div>
